...
export const POIS = [
  ...
  {
    id: "es_mad_jarama_batalla",
    nombre: "Valle del Jarama (batalla de 1937)",
    emoji: "⚔️",
    lat: 40.2564,
    lng: -3.4583,
    nivel: 1,
    categorias: ["historia", "batallas", "guerra_civil", "memoria"],
    tipo: "campo_batalla",
    radioActivacionMetros: 8000,
    ...
    prioridad: 140,
    cooldownMin: 150,
    intereses: ["guerra_civil", "brigadas_internacionales", "frente_madrid", "batalla"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
...

  {
    ...
    nombre: "Campo de Alarcos (batalla de 1195)",
    emoji: "⚔️",
    lat: 38.9425,
    lng: -3.9642,
    nivel: 1,
    ...
    prioridad: 145,
    cooldownMin: 150,
    intereses: ["reconquista", "almohades", "alfonso_viii", "batalla", "derrota"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
...

  {
    ...
    lng: -5.9273,
    nivel: 1,
    categorias: ["historia", "batallas", "pueblo", "cultura", "ruta"],
    tipo: "pueblo_historico",
    radioActivacionMetros: 7000,
    ...
    prioridad: 130,
    cooldownMin: 80,
    intereses: ["guadalete", "reconquista", "invasion_arabe", "711"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
...

  {
    ...
    lng: -1.1069,
    nivel: 1,
    categorias: ["historia", "batallas", "guerra_civil", "provincia", "capital", "cultura", "ruta"],
    tipo: "ciudad_batalla",
    radioActivacionMetros: 12000,
    ...
    prioridad: 140,
    cooldownMin: 120,
    intereses: ["guerra_civil", "batalla_teruel", "frente", "invierno"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
    sub_pois: [
      {
...

  {
    ...
    lng: -5.0512,
    nivel: 1,
    categorias: ["historia", "batallas", "reconquista", "santuario", "montaña"],
    tipo: "campo_batalla",
    radioActivacionMetros: 7000,
    ...
    prioridad: 145,
    cooldownMin: 60,
    intereses: ["reconquista", "batalla", "origen_espana", "don_pelayo"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
...

  {
    ...
    lng: -6.5226,
    nivel: 1,
    categorias: ["historia", "batallas", "pueblo", "arquitectura", "cultura", "datosCuriosos"],
    tipo: "ciudad_batalla",
    radioActivacionMetros: 3500,
    ...
    prioridad: 138,
    cooldownMin: 90,
    intereses: ["guerra_independencia", "asedio", "wellington", "napoleon"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
...

  {
    ...
    lng: -2.8179,
    nivel: 2,
    categorias: ["historia", "batallas", "pueblo", "arquitectura", "datosCuriosos"],
    tipo: "pueblo_batalla",
    radioActivacionMetros: 3000,
    ...
    prioridad: 130,
    cooldownMin: 90,
    intereses: ["almanzor", "batalla", "reconquista", "leyenda"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
...

  {
    ...
    lng: -1.0975,
    nivel: 1,
    categorias: ["historia", "batallas", "castillo", "ciudad", "ruta"],
    tipo: "ciudad_batalla",
    radioActivacionMetros: 10000,
    ...
    prioridad: 140,
    cooldownMin: 100,
    intereses: ["guerra_sucesion", "batalla", "borbones", "austria"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
...

  {
    ...
    lng: -0.2734,
    nivel: 1,
    categorias: ["historia", "batallas", "ciudad", "ruta"],
    tipo: "ciudad_batalla",
    radioActivacionMetros: 8500,
    ...
    prioridad: 145,
    cooldownMin: 75,
    intereses: ["anibal", "asedio", "roma", "cartago", "segunda_guerra_punica"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
    sub_pois: [
      {
...

  {
    ...
    lng: -6.97528,
    nivel: 1,
    categorias: ["historia", "batallas", "provincia", "capital", "frontera", "cultura"],
    tipo: "ciudad_batalla",
    radioActivacionMetros: 10000,
    ...
    prioridad: 138,
    cooldownMin: 120,
    intereses: ["guerra_independencia", "asedio", "reconquista", "frontera"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
    sub_pois: [
      {
...

  {
    ...
    lng: -1.3192,
    nivel: 1,
    categorias: ["historia", "batallas", "montaña", "camino"],
    tipo: "puerto_batalla",
    radioActivacionMetros: 6000,
    ...
    prioridad: 130,
    cooldownMin: 75,
    intereses: ["batalla", "carlomagno", "vascos", "camino_de_santiago"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
...

  {
    ...
    lng: -2.6726,
    nivel: 1,
    categorias: ["historia", "batallas", "capital", "ruta", "cultura"],
    tipo: "ciudad_batalla",
    radioActivacionMetros: 10000,
    ...
    prioridad: 140,
    cooldownMin: 80,
    intereses: ["guerra_independencia", "batalla", "napoleon", "wellington"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
    sub_pois: [
      {
  ...
  {
    id: "es_so_numancia_asedio",
    nombre: "Numancia (el asedio romano)",
    emoji: "⚔️",
    lat: 41.8056,
    lng: -2.4297,
    nivel: 1,
    categorias: ["historia", "batallas", "asedio", "romano", "datosCuriosos"],
    tipo: "campo_batalla",
    radioActivacionMetros: 8000,
    ...
    prioridad: 165,
    cooldownMin: 180,
    intereses: ["asedio", "numancia", "roma", "celtiberos", "resistencia"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },

  {
    id: "es_ca_guadalete_batalla",
    nombre: "Río Guadalete (batalla de 711)",
    emoji: "⚔️",
    lat: 36.7167,
    lng: -5.9833,
    nivel: 1,
    categorias: ["historia", "batallas", "conquista", "datosCuriosos"],
    tipo: "campo_batalla",
    radioActivacionMetros: 9000,
    ...
    prioridad: 160,
    cooldownMin: 180,
    intereses: ["invasion_arabe", "711", "don_rodrigo", "tariq", "fin_hispania_visigoda"],
    // sponsor: { sponsorId, sponsorNombre, mensaje, url },
    // eventos: [{ id, titulo, descripcion, startDate, endDate, importancia }],
  },
